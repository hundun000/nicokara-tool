...
public class LyricLinePO {
    ...
    private String category; //文本类型数组，日语学习点分类，严格按照后文的category值域。如果一个词的学习点同时符合多个category，则均列出在数组里。
    ...
    public static String toId(String songId, int groupIndex, int lineIndex) {
        return songId + "_" + groupIndex + "_" + lineIndex;
    }
}
