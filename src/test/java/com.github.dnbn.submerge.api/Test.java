...
public class Test {
    ...
    public static void main(String args[]) {
        ...
        Set<? extends TimedLine> timedLines = getTimedLines(false);
        printTimeLine(timedLines, false);

    }

    public static Set<? extends TimedLine> getTimedLines(boolean isSrt) {
        File assFile = new File("test-input/input.ass");
        File srtFile = new File("test-input/input.srt");
